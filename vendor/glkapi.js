...
function accept_ui_event(obj) {
    ...
    case 'geoquest':
        handle_geoquest_input(obj.window, obj.value);
        break;
...
// same as handle_line_input except echo command
function handle_geoquest_input(disprock, input, termkey) {
    var ix;

  qlog("### handle_geoquest_input: " + input);
